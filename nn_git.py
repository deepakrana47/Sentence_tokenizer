...
from optimization import Optimization_variable, Optimization
from dataset_maker_git import make_dataset
...
class NN:
    ...
    def __init__(self, isize, hsize, osize, batch_size=100, epoch=5, neta=0.0001, op_method='rmsprop'):
        self.util = Util()
        self.isize = isize
        self.hsize = hsize
        self.osize = osize
        ...
        self.optimum_i2h = Optimization(Optimization_variable(method=op_method, i_size=isize, o_size=hsize), method=op_method, learning_rate=neta)
        self.optimum_h2o = Optimization(Optimization_variable(method=op_method, i_size=hsize, o_size=osize), method=op_method, learning_rate=neta)
    ...
    def pridect(self, x):
        ...
        # hidden to output activation
        o = softmax(np.dot(self.wh12o, h1))
        return o
